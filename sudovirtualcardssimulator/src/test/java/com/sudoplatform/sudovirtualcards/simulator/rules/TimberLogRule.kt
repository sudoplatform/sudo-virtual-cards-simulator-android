...
package com.sudoplatform.sudovirtualcards.simulator.rules
...
/**
 * Log rule that sets up a timber logger that logs to the console
 * test console for easy viewing of log results.
 */
class TimberLogRule(
    /**
