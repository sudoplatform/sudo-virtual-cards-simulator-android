...
internal object SudoVirtualCardsSimulatorTransformer {
     ...
     */
    fun buildDebitFromMutationResult(mutationResult: SimulateDebitMutation.SimulateDebit): SimulateDebitResponse =
     ...
     */
    fun buildRefundFromMutationResult(mutationResult: SimulateRefundMutation.SimulateRefund): SimulateRefundResponse =
     ...
     */
    fun buildReversalFromMutationResult(mutationResult: SimulateReversalMutation.SimulateReversal): SimulateReversalResponse =
...
private fun Double.toDate(): Date = Date(this.toLong())
